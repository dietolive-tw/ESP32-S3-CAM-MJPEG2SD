...
#if defined(CAMERA_MODEL_FREENOVE_ESP32S3_CAM) || defined(CAMERA_MODEL_ESP32_S3_CAM)
// Define I2S Audio Pins (shared clock between mic and amp)
#define I2S_SCK 1   // I2S BCLK (shared mic SCK / amp BCLK)
#define I2S_WS 2    // I2S LRCLK (shared mic WS / amp LRCLK)
#define I2S_SD 14   // I2S mic data
#define I2S_BCLK 1  // I2S amp BCLK
#define I2S_LRCLK 2 // I2S amp LRCLK
#define I2S_DIN 21  // I2S amp data
// Define PCF8575 I2C expander pins for stepper motors
#define PCF8575_SDA 41
#define PCF8575_SCL 42
