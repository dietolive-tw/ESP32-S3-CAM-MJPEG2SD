       ...
       function sendWsMsg(msg, index = 0) {
        ...
        function setListeners() {
          ...
          document.addEventListener("click", function (event) {
            ...
            // other buttons (skip disabled buttons)
            else if (e.tagName == 'BUTTON' && !e.disabled) processStatus(ID, e.id, e.value);
      ...
      async function runMic(index) {
        ...
        try {
          ...
          if (!audioContextMic.audioWorklet) alert('Mic: AudioWorklet not supported in this browser/environment');
          else {
